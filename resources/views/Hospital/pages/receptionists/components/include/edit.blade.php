...
@section('header_line')
    ...
    <li class="breadcrumb-item">تعديل موظف استقبال</li>
@stop
@section('content')
            ...
            <div class="col-lg-12 basic-info">
                <div class="card">
                    <div class="card-header">
                        <h5><i style="margin-left: 6px;color: darkred;" class="fa fa-user"></i>تعديل موظف استقبال </h5>
                    </div>
                    <div class="card-body">
                        <form id="edit_member" data-route="{{ route('hospital.receptionist.update',$data->id) }}">
                            <div class="row">
                                <div class="col-md-6">
                                            ...
                                            <div class="image-upload">
                                                ...
                                                <div  style="margin-top: 5px;display: inline-block;">
                                                    <a href="#" data-toggle="modal" data-target="#model_item_image">
                                                        <img id="show_image" src="{{ asset('Hospital/Images/'.$data->user->photo) }}" style="width: 48px;height: 48px;object-fit: cover;border-radius: 50%;" class="" alt="">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
    ...
    @include('Hospital.pages.receptionists.components.include.imageModal',['edit'=>true])
@endsection
@section('script')
    ...
    @include('hospital.pages.receptionists.components.extends.ajax.update')
@endsection
