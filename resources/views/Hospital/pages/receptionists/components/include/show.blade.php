...
@section('content')
                            ...
                            <div class="card-body" style="border-top: 3px solid #a92c2d;">
                                <ul class="nav nav-pills" style="border-bottom: 1px solid #ddd;border-top: 1px solid #ddd;margin-bottom: 29px;">
                                    <li class="nav-item" style="padding-top: 13px !important;padding-bottom: 10px !important;">
                                        <a class="nav-link active" id="base-pill31" href="{{ route('hospital.receptionist.edit',['id'=>$data->id,'name'=>str_replace(' ','_',$data->user->name)]) }}"
                                           aria-expanded="true">
                                            تعديل
                                        </a>
                                    </li>
    ...
    @include('Hospital.pages.receptionists.components.include.imageShow',['photo'=>$data->user->photo])
@endsection
