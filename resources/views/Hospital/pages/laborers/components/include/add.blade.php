...
@section('header_line')
    ...
    <li class="breadcrumb-item">اضافة عامل</li>
@stop
@section('content')
            ...
            <div class="col-lg-12 basic-info">
                <div class="card">
                    <div class="card-header">
                        <h5><i style="margin-left: 6px;color: darkred;" class="fa fa-user"></i>إضافة عامل جديد</h5>
                    </div>
                    <div class="card-body">
...
@include('Hospital.pages.laborers.components.include.imageModal')
@endsection
@section('script')
    @include('Hospital.pages.laborers.components.extends.ajax.add')
