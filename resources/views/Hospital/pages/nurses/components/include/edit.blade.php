...
@section('header_line')
    ...
    <li class="breadcrumb-item">تعديل ممرض</li>
@stop
@section('content')
            ...
            <div class="col-lg-12 basic-info">
                <div class="card">
                    <div class="card-header">
                        <h5><i style="margin-left: 6px;color: darkred;" class="fa fa-user-nurse"></i>تعديل ممرض </h5>
                    </div>
                    <div class="card-body">
                        <form id="edit_member" data-route="{{ route('hospital.nurse.update',$data->id) }}">
                            <div class="row">
                                <div class="col-md-6">
    ...
    @include('Hospital.pages.doctors.components.include.imageModal',['edit'=>true])
@endsection
@section('script')
    ...
    @include('hospital.pages.nurses.components.extends.ajax.update')
@endsection
