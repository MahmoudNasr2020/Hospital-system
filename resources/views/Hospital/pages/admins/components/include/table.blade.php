<div class="col-md-12 col-lg-12 col-xl-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title" style="margin-right: 22px; display: inline-block">المسؤولين</h4>
               ...
               <div class="row">
                   <div class="col-6">
                       <button type="button" class="btn btn-icon btn-outline-primary mr-1 mb-1" id="add_new_item" >
                           <a href="{{ route('hospital.admin.create') }}">
                   ...
                   <div class="col-6">
                       <button type="button" class="btn btn-icon btn-outline-danger mr-1 mb-1" id="multi_delete"
                               data-route="{{ route('hospital.admin.multi_delete') }}" style="float: left;display: none">
