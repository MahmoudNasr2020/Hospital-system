...
@section('header_line')
    ...
    <li class="breadcrumb-item">تعديل دكتور</li>
@stop
@section('content')
            ...
            <div class="col-lg-12 basic-info">
                <div class="card">
                    <div class="card-header">
                        <h5><i style="margin-left: 6px;color: darkred;" class="fa fa-user-md"></i>تعديل دكتور </h5>
                    </div>
                    <div class="card-body">
                        <form id="edit_member" data-route="{{ route('hospital.doctor.update',$data->id) }}">
                            <div class="row">
                                <div class="col-md-6">
