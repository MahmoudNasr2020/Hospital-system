...
@section('content')
                            ...
                            <div class="card-body box box-primary">
                                <div class="box-body box-profile" >
                                    ...
                                    <p style="text-align: center;color: red;" id="text_disabled_user">
                                        {{ $data->user->status  == 'disabled' ? 'This Doctor is Disabled' : '' }}
                                    </p>
                                    ...
                                    <ul class="list-group list-group-unbordered">
                                        ...
                                        <li class="list-group-item listnoback">
                                            <b>القسم</b> <a class="pull-right text-aqua"
                                                            style="float:left">{{ $data->department->name }}</a>
                                        </li>
                                        <li class="list-group-item listnoback">
                            ...
                            <div class="card-body" style="border-top: 3px solid #a92c2d;">
                                <ul class="nav nav-pills" style="border-bottom: 1px solid #ddd;border-top: 1px solid #ddd;margin-bottom: 29px;">
                                    <li class="nav-item" style="padding-top: 13px !important;padding-bottom: 10px !important;">
                                        <a class="nav-link active" id="base-pill31" href="{{ route('hospital.doctor.edit',['id'=>$data->id,'name'=>str_replace(' ','_',$data->user->name)]) }}"
                                           aria-expanded="true">
                                            تعديل
                                        </a>
                                    </li>
    ...
    @include('Hospital.pages.doctors.components.include.imageShow',['photo'=>$data->user->photo])
@endsection
