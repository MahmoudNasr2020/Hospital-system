...
namespace App\Http\Requests\Hospital\Nurse;
...
class UpdateNurseRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'identify_no'   =>        ['required','numeric','unique:nurses,identify_no,'.$this->id],
            'department_id' =>        ['required','not_in:0'],
            'gender'        =>        ['required','not_in:0'],
            'status'        =>        ['required','not_in:0'],
            'salary'        =>        ['required','numeric'],
            'date_of_birth' =>        ['required','date_format:d/m/Y'],
            'mobile_phone' =>         ['required','unique:nurses,mobile_phone,'.$this->id],
            'home_phone'   =>         ['nullable'],
