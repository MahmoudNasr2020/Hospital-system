...
class DoctorRepository implements DoctorRepositoryInterface
{
    ...
    {
        return $dataTable->render('Hospital.pages.doctors.index');
    }
    ...
    public function create()
    {
        ...
        $roles = Role::all();
        return view('Hospital.pages.doctors.components.include.add',compact('data','roles'));
    }
    ...
    public function store($request)
    {
        ...
        {
             $image = $this->imageUpload('doctors',$request->file('image'));
        ...
        $member = Doctor::create($request->except(['name','user_name','password','password_confirmation','photo']));
    ...
    {
        $data = Doctor::with('user','department')->findOrFail($id);
        return view('Hospital.pages.doctors.components.include.show',compact('data'));
    }
    /** @noinspection PhpUndefinedMethodInspection */
    public function edit($data)
    {
        $data = Doctor::with('user')->findOrFail($data);
        $departments = Department::select('id','name')->get();
        $roles = Role::get();
        $data_roles = $data->user->roles->pluck('name')->toArray();
        return view('Hospital.pages.doctors.components.include.edit',compact('data','departments','roles','data_roles'));
    }
    /** @noinspection PhpUndefinedMethodInspection
    ...
    {
        $item = Doctor::find($item);
        if(!$item)
        {
            return 'error';
        }
        $this->deleteImage('Hospital/Images/doctors/'.$item->photo);
